...
public class PolyOrientedCurve2D<T extends ContinuousOrientedCurve2D> extends
     ...
     * @since 0.8.1
     */
    public static <T extends ContinuousOrientedCurve2D> PolyOrientedCurve2D<T> create(
            T... curves) {
        return new PolyOrientedCurve2D<T>(curves);
    }
     ...
     * @since 0.8.1
     */
    public static <T extends ContinuousOrientedCurve2D> PolyOrientedCurve2D<T> createClosed(
            T... curves) {
    ...
    @Override
    public PolyOrientedCurve2D<? extends ContinuousOrientedCurve2D> transform(
