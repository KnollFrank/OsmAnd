...
public class GenericDomain2D implements Domain2D {
    ...
    public Domain2D clip(Box2D box) {
        return new GenericDomain2D(Boundaries2D.clipBoundary(this.boundary(),
                box));
    }
    ...
    public boolean almostEquals(GeometricObject2D obj, double eps) {
        ...
        return boundary.almostEquals(domain.boundary, eps);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return boundary.equals(domain.boundary);
    }
}
