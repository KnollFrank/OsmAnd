 ...
 * 
 */
public class ShapeArray2D<T extends Shape2D> implements ShapeSet2D<T>,
        Cloneable {

    // ===================================================================
    // Static constructors

    public static <T extends Shape2D> ShapeArray2D<T> create(
            Collection<T> shapes) {
    ...
    public ShapeSet2D<? extends Shape2D> transform(AffineTransform2D trans) {
        ...
        ShapeArray2D<Shape2D> result = new ShapeArray2D<Shape2D>(shapes.size());
