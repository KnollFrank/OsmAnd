...
/**
 * Interface for shapes composed of a finite set of points. Single points should
 * also implements this interface. Implementations of this interface can
...
public interface PointShape2D extends CirculinearShape2D, Iterable<Point2D> {
    ...
    /**
     * Transforms the point shape by an affine transform. The result is an
     * instance of PointShape2D.
     */
