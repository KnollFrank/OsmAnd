 ...
 * positions t between 2*k+1 and 2*k+2 belong to the curve k if t<2*k+1.5, or to
 * the curve k+1 if t>2*k+1.5
 * </p>
 * 
 * @author Legland
 */
public class CurveArray2D<T extends Curve2D> implements CurveSet2D<T>,
    ...
    public Point2D point(double t) {
        ...
        if (indc * 2 == nc) {
            ...
            double pos = Curves2D.fromUnitSegment(t - nc, curve.t0(),
                    curve.t1());
