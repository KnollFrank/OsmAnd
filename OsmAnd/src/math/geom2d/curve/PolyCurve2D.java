...
public class PolyCurve2D<T extends ContinuousCurve2D> extends CurveArray2D<T>
     ...
     */
    protected static <T extends ContinuousCurve2D> Collection<T> wrapCurve(
            T curve) {
     ...
     * 
     * @param curves
     *            the curves that constitutes this PolyCurve2D
     */
     ...
     * instance of CurveSet2D<ContinuousCurve2D> which contains 0 curves.
     */
    @Override
    public CurveSet2D<? extends ContinuousCurve2D> clip(Box2D box) {
        ...
        CurveArray2D<ContinuousCurve2D> result = new CurveArray2D<ContinuousCurve2D>(
                set.size());
