...
public class InvertedRay2D extends AbstractLine2D implements Cloneable {
    ...
    /**
     * Static factory for creating a new inverted ray with given direction to
     * target.
     * 
    ...
    /**
     * Returns another instance of InvertedRay2D, parallel to this one, and
     * located at the given distance.
     * 
    ...
    public InvertedRay2D transform(AffineTransform2D trans) {
        ...
        return new InvertedRay2D(x1, y1, dx * tab[0] + dy * tab[1], dx * tab[3]
                + dy * tab[4]);
    }
