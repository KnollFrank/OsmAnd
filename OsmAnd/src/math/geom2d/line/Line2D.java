 ...
 * {@link LineSegment2D}.
 */
public class Line2D extends AbstractSmoothCurve2D implements LinearElement2D,
        Cloneable {
     ...
     * {@link Point2D#ccw(Point2D, Point2D, Point2D) Point2D.ccw}
    ...
    public Line2D parallel(double d) {
        ...
        return new Line2D(x0 + dy * d2, y0 - dx * d2, x0 + dx + dy * d2, y0
                + dy - dx * d2);
    }
     ...
     * 
     * @see
     * math.geom2d.line.LinearShape2D#intersection(math.geom2d.line.LinearShape2D
     * )
     */
