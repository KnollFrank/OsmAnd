 ...
 * 
 *     // put lines in a set
 *     CirculinearCurveSet2D&lt;StraightLine2D&gt; set = CirculinearCurveArray2D.create(
 *             line1, line2);
 * }
 * </pre>
 * 
 ...
 * 
 */
public class CirculinearCurveArray2D<T extends CirculinearCurve2D> extends
        CurveArray2D<T> implements CirculinearCurveSet2D<T> {
     ...
     * .CircleInversion2D)
     */
    public CirculinearCurveArray2D<CirculinearCurve2D> transform(
            CircleInversion2D inv) {
        // Allocate array for result
        CirculinearCurveArray2D<CirculinearCurve2D> result = new CirculinearCurveArray2D<CirculinearCurve2D>(
                curves.size());
    ...
    @Override
    public CirculinearCurveArray2D<? extends CirculinearCurve2D> subCurve(
            double t0, double t1) {
        ...
        for (Curve2D curve : subcurve) {
            if (curve instanceof CirculinearCurve2D)
                ...
                System.err
                        .println("CirculinearCurveArray2D.getSubCurve: error in class cast");
        }
