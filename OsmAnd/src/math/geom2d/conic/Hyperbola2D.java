 ...
 */
public class Hyperbola2D extends ContourArray2D<HyperbolaBranch2D> implements
        Conic2D, Cloneable {
    ...
    public Point2D toLocal(Point2D point) {
        point = point.transform(AffineTransform2D.createTranslation(-xc, -yc));
        point = point.transform(AffineTransform2D.createRotation(-theta));
        point = point.transform(AffineTransform2D.createScaling(1.0 / a,
                1.0 / b));
        return point;
    }
    ...
    private LinearShape2D formatLine(LinearShape2D line) {
        ...
        line = line
                .transform(AffineTransform2D.createScaling(1.0 / a, 1.0 / b));
        return line;
    }
    ...
    public Hyperbola2D transform(AffineTransform2D trans) {
        ...
        result.xc = center.x();
        result.yc = center.y();
        // TODO: check convention for transform with indirect transform, see
        // Curve2D.
