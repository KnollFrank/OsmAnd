 ...
 * @author dlegland
 */
public class Parabola2D extends AbstractSmoothCurve2D implements Contour2D,
        Conic2D, Cloneable {
     ...
     * 
     * @param vertex
     *            the vertex point of the parabola
     * @param focus
    ...
    public double[] conicCoefficients() {
        ...
        AffineTransform2D transform = AffineTransform2D.createRotation(theta)
                .chain(AffineTransform2D.createTranslation(xv, yv));
    ...
    public CurveSet2D<ParabolaArc2D> clip(Box2D box) {
        ...
        CurveArray2D<ParabolaArc2D> result = new CurveArray2D<ParabolaArc2D>(
                set.size());
    ...
    public String toString() {
        return String.format("Parabola2D(%f,%f,%f,%f)", xv, yv, a, theta);
    }
