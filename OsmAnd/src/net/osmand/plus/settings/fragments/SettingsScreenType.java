...
public enum SettingsScreenType {
	...
	FOOTPATH_NAVIGATION(FootPathNavigationSettingFragment.class.getName(), true, ApplyQueryType.NONE, R.xml.footpath_navigation_setting, R.layout.profile_preference_toolbar_with_switch),
